...
/**
 * A board layout with branching paths.
 * 0-7: Top row
 * 8: Branch 1 (down to row 4)
 * 9-15: Branch 2 (continue right)
 */
export const BOARD_NODES: BoardNode[] = [
  ...
  { id: 3, col: 3, row: 0, next: [4, 18] }, // BRANCH!
  ...
  { id: 17, col: 11, row: 6, next: [26] }, // Merge from below
  
  // Internal Branch 1 (from id 3 down)
  ...
  { id: 25, col: 7, row: 4, next: [26] }, // Merge point
  
  // Middle section after merge
  ...
  { id: 43, col: 0, row: 1, next: [0] }, // Loop
]

export const BOARD_PATH = BOARD_NODES // Repurpose for compatibility if needed
